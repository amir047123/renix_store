    ...
    <div className=''>
      ...
      <div className="max-w-md mx-auto p-8 bg-white rounded-lg shadow-lg">
        ...
        <div className="flex justify-center">
         <Link to="/shop" > <button className="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Continue Shopping</button></Link>
        </div>
      </div>
    </div>
    </div>
