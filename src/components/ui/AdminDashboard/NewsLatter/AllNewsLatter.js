    ...
    async function fetchNewsLatter() {
      try {
        const response = await axios.get(
          "https://apistore.renixlaboratories.com.bd/api/v1/newsLatter/getNewsLatters"
        );
                ...
                <div
                  onClick={() => {
                    DeleteHook({
                      refetch,
                      setRefetch,
                      url: `https://apistore.renixlaboratories.com.bd/api/v1/newsLatter/deleteNewsLatter/${newsLatter?._id}`,
                    });
                  }}
