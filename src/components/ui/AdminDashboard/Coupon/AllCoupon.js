    ...
    async function fetchCoupons() {
      try {
        const response = await axios.get(
          "https://serverrenixstore.niroghealthplus.com/api/v1/coupon/getCoupons"
        );
                ...
                <div
                  onClick={() => {
                    DeleteHook({
                      refetch,
                      setRefetch,
                      url: `https://serverrenixstore.niroghealthplus.com/api/v1/coupon/deleteCoupons/${coupon?._id}`,
                    });
                  }}
